    ...
    <div className="form-grid-2">
      {Object.entries(settings[section]).map(([key, value]) => (
        <div key={key} className="form-group">
          ...
          <input className="form-input" value={String(value)} onChange={e => updateSection(section, key, e.target.value)} />
        </div>
      ))}
    </div>
  );
      ...
      <div className="card">
        <div className="page-toolbar">
          <div>
            ...
            <div className="card-subtitle">Cấu hình thông tin trạm, thiết bị, thông báo và realtime refresh.</div>
          </div>
