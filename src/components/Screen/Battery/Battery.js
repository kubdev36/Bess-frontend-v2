              ...
              >
                ...
                <div className="DAT_BatteryMobile_Overview_Card_Header_Box">
                  <div className="DAT_BatteryMobile_Overview_Card_Header_Box_Item">
                    ...
                    <div className="DAT_BatteryMobile_Overview_Card_Header_Box_Item_Value">{c.soc}%</div>
                  </div>

                  <div className="DAT_BatteryMobile_Overview_Card_Header_Box_Item">
                    <div className="DAT_BatteryMobile_Overview_Card_Header_Box_Item_Label">SOH:</div>
                    <div className="DAT_BatteryMobile_Overview_Card_Header_Box_Item_Value">{c.soh}%</div>
                  </div>

                  <div className="DAT_BatteryMobile_Overview_Card_Header_Box_Item">
                    <div className="DAT_BatteryMobile_Overview_Card_Header_Box_Item_Label">Temp:</div>
                    <div className="DAT_BatteryMobile_Overview_Card_Header_Box_Item_Value">{c.temperature}°C</div>
                  </div>
                </div>
              </div>
            ))}
              ...
              <table className="DAT_BatteryMobile_RackList_Table_Main">
                <thead className="DAT_BatteryMobile_RackList_Table_Main_Head">
                  <tr>
                    ...
                    <th className="DAT_BatteryMobile_RackList_Table_Main_Head_Th">Status</th>
                  </tr>
                </thead>
                <tbody className="DAT_BatteryMobile_RackList_Table_Main_Body">
                  {filteredRacks.map((r) => (
                    <tr
                      key={r.id}
                      className={`DAT_BatteryMobile_RackList_Table_Main_Body_Row ${selectedRack?.id === r.id ? "DAT_BatteryMobile_RackList_Table_Main_Body_Row--selected" : ""} ${r.status === "Warning" ? "DAT_Battery_RackList_Table_Main_Body_Row--warning" : ""}`}
              ...
              >
                ...
                <div className="DAT_ModalMobile_Overlay_BoxCell_Cell">
                  {selectedRack.cells.map((cell) => {
                    return (
                      <div className={cell.status === "Normal" ? `DAT_ModalMobile_Overlay_BoxCell_Cell_Card` : "DAT_ModalMobile_Overlay_BoxCell_Cell_Card--High"}>
                        <div className="DAT_ModalMobile_Overlay_BoxCell_Cell_Card_Header">
                          ...
                          <div className="DAT_ModalMobile_Overlay_BoxCell_Cell_Card_Header_Status">
                            ...
                            <span className={cell.status === "Normal" ? `DAT_ModalMobile_Overlay_BoxCell_Cell_Card_Header_Status_Value` : "DAT_ModalMobile_Overlay_BoxCell_Cell_Card_Header_Status_Value_High"}>{cell.status}</span>
                          </div>
                        </div>
