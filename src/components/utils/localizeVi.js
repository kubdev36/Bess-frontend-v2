...
const inlineTranslations = {
  ...
  "Real-time operations, alarms, reports and control in one view.":
    "Vận hành thời gian thực, cảnh báo, báo cáo và điều khiển trong một màn hình.",
  "The dashboard brings together live battery storage monitoring, energy flow awareness, operator actions, scheduling and audit history for the whole BESS station.":
    "Bảng điều khiển tập trung giám sát lưu trữ pin theo thời gian thực, luồng năng lượng, thao tác vận hành, lập lịch và lịch sử kiểm tra cho toàn bộ trạm BESS.",
  "Track live SOC, SOH, power and temperature values.":
    "Theo dõi trực tiếp SOC, SOH, công suất và nhiệt độ.",
  "Inspect energy exchange between Grid, PV, PCS, Battery and Load.":
    "Theo dõi trao đổi năng lượng giữa Lưới điện, PV, PCS, Pin và Tải.",
  "Acknowledge active alarms and review recent events.":
    "Xác nhận cảnh báo đang hoạt động và xem lại các sự kiện gần đây.",
  "Open day, month and year energy analytics.":
    "Mở phân tích năng lượng theo ngày, tháng và năm.",
  "Run charge, discharge and operating mode commands.":
    "Thực hiện lệnh sạc, xả và chuyển chế độ vận hành.",
  "Adjust thresholds, protections and operating limits.":
    "Điều chỉnh ngưỡng, bảo vệ và giới hạn vận hành.",
  ...
  "Safety interlocks currently satisfied":
    "Các liên động an toàn hiện đang được thỏa mãn",
  "Realtime Overview": "Tổng quan thời gian thực",
  "Core KPIs for battery, power conversion and grid interaction.":
    "Các KPI cốt lõi cho pin, chuyển đổi công suất và tương tác lưới điện.",
  "Live topology between Grid, PV, PCS, Battery and Load.":
    "Sơ đồ kết nối trực tiếp giữa Lưới điện, PV, PCS, Pin và Tải.",
  "Operational status for key modules and interfaces.":
    "Trạng thái vận hành của các mô-đun và giao diện chính.",
  "Battery, grid, PV and load power profile.":
    "Biểu đồ công suất của pin, lưới, PV và tải.",
  "Charge reserve behavior across the day.":
    "Diễn biến dung lượng sạc dự trữ trong ngày.",
  "Daily charge, discharge and PV production trend.":
    "Xu hướng sạc, xả và sản lượng PV theo ngày.",
  "Current alarms plus latest operator-visible events.":
    "Cảnh báo hiện tại cùng các sự kiện mới nhất mà người vận hành thấy được.",
  "Direct access to control, settings, schedule, permissions and audit functions.":
    "Truy cập nhanh đến điều khiển, cài đặt, lịch, phân quyền và chức năng kiểm tra.",
  "Enabled schedules queued for operation.":
    "Các lịch đang bật đã được xếp hàng để vận hành.",
  "Access control and role coverage.": "Kiểm soát truy cập và phạm vi vai trò.",
  "Operating thresholds and interlock summary.":
    "Tóm tắt ngưỡng vận hành và liên động.",
  "Latest control commands sent to the system.":
    "Các lệnh điều khiển mới nhất đã gửi tới hệ thống.",
  "Recent user actions and system audit records.":
    "Các thao tác người dùng gần đây và bản ghi kiểm tra hệ thống.",
  ...
  "Táº¡o lá»‹ch sáº¡c, xáº£, standby, backup, peak shaving vÃ  maintenance.":
    "Tạo lịch sạc, xả, chờ, dự phòng, cắt đỉnh và bảo trì.",
  "Quáº£n lÃ½ tÃ i khoáº£n, role, tráº¡ng thÃ¡i vÃ  hÃ nh Ä‘á»™ng reset password.":
    "Quản lý tài khoản, vai trò, trạng thái và thao tác đặt lại mật khẩu.",
};
